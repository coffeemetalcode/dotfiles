...
;; ignore dirs in projectile operations (like projectile-ripgrep)
...
;; move lines or regions up or down with Alt + arrow-<up | down>
...
;; (add-to-list 'default-frame-alist '(alpha-background . 94)) ; Sets default background opacity for new frames
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(atom-one-dark-theme command-log-mode company copilot copilot-chat
			 ...
			 minimap mood-one-theme ng2-mode
			 projectile-ripgrep rainbow-delimiters
			 spacious-padding treemacs-nerd-icons web-mode
			 which-key)))
(custom-set-faces
